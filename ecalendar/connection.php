  ...
  if(isset($pseudo,$pass)) 
  {
    ...
    try
    {
      ...
      if ($nb_result == 1)
      {
        ...
        header("Location: ../ecalendar/calendar.php");
            exit(); 
...
<div id = "connexion">
    ...
    <fieldset><br>Connexion</fieldset>
    <p><label for="pseudo">Pseudo : </label><input type="text" name="pseudo" id="pseudo" /></p>
    <p><label for="pass">Mot de passe : </label><input type="password" name="pass" id="pass" /></p>
    <p><input type="submit" value="Envoyer" id = "valider" /></p>
    </form>
    <p class="register">Vous n'avez pas encore de compte ?<a href="http://weshweshmusic.com/ecalendar/adduser.php"> inscrivez-vous</a></p>
</div>
</body>
</html>